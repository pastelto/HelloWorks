									...
									<tbody>
										<c:forEach items="${ list }" var="trash">
											<tr>
												...
												<td>${ sent.mailNo }</td>
												<td class="mailbox-name">${ trash.mailSndrDept }${ trash.mailSndrName }
													${ trash.mailSndrJobName }</td>
												<td class="mailbox-subject"><b>${ trash.mailTitle }</b></td>
												<td class="mailbox-date float-right">${ trash.mailDate }</td>
