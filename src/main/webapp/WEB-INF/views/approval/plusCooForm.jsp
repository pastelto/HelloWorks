...
<body>
					...
					<div class="card-footer">
						<div class="float-right">
							<button id="submitBtn" type="button"
								class="btn btn-default btn-sm" onclick="backApp();">+ 협조 추가</button>
						</div>
					</div>
				</div>
				</div>
	...
	<script>
		...
		function backApp(){
			...
			var level1 = $("#applineTable>thead>tr>td:eq(0)").text();
			var level2 = $("#applineTable>thead>tr>td:eq(1)").text();
			var level3 = $("#applineTable>thead>tr>td:eq(2)").text();
			var level4 = $("#applineTable>thead>tr>td:eq(3)").text();
			...
			var num1 = $("#applineTable>tbody>tr>td:eq(0)").text();
			var num2 = $("#applineTable>tbody>tr>td:eq(1)").text();
			var num3 = $("#applineTable>tbody>tr>td:eq(2)").text();
			var num4 = $("#applineTable>tbody>tr>td:eq(3)").text();
			...
			var name1 = $("#applineTable>tfoot>tr>td:eq(0)").text();
			var name2 = $("#applineTable>tfoot>tr>td:eq(1)").text();
			var name3 = $("#applineTable>tfoot>tr>td:eq(2)").text();
			var name4 = $("#applineTable>tfoot>tr>td:eq(3)").text();
			...
			if(divNo == 1){
				window.opener.document.getElementById("coo_level1_1").value = level1;
				window.opener.document.getElementById("coo_level1_2").value = level2;
				window.opener.document.getElementById("coo_level1_3").value = level3;
				window.opener.document.getElementById("coo_level1_4").value = level4;
				
				window.opener.document.getElementById("coo_name1_1").value = name1;
				window.opener.document.getElementById("coo_name1_2").value = name2;
				window.opener.document.getElementById("coo_name1_3").value = name3;
				window.opener.document.getElementById("coo_name1_4").value = name4;
				
				window.opener.document.getElementById("cooperator1_1").value = num1;
				window.opener.document.getElementById("cooperator1_2").value = num2;
				window.opener.document.getElementById("cooperator1_3").value = num3;
				window.opener.document.getElementById("cooperator1_4").value = num4;
				
				window.close();
				
			} else if (divNo == 2){
				window.opener.document.getElementById("coo_level2_1").value = level1;
				window.opener.document.getElementById("coo_level2_2").value = level2;
				window.opener.document.getElementById("coo_level2_3").value = level3;
				window.opener.document.getElementById("coo_level2_4").value = level4;
				
				window.opener.document.getElementById("coo_name2_1").value = name1;
				window.opener.document.getElementById("coo_name2_2").value = name2;
				window.opener.document.getElementById("coo_name2_3").value = name3;
				window.opener.document.getElementById("coo_name2_4").value = name4;
				
				window.opener.document.getElementById("cooperator2_1").value = num1;
				window.opener.document.getElementById("cooperator2_2").value = num2;
				window.opener.document.getElementById("cooperator2_3").value = num3;
				window.opener.document.getElementById("cooperator2_4").value = num4;
				
				window.close();
				
			} else if (divNo == 3){
				window.opener.document.getElementById("coo_level3_1").value = level1;
				window.opener.document.getElementById("coo_level3_2").value = level2;
				window.opener.document.getElementById("coo_level3_3").value = level3;
				window.opener.document.getElementById("coo_level3_4").value = level4;
				
				window.opener.document.getElementById("coo_name3_1").value = name1;
				window.opener.document.getElementById("coo_name3_2").value = name2;
				window.opener.document.getElementById("coo_name3_3").value = name3;
				window.opener.document.getElementById("coo_name3_4").value = name4;
				
				window.opener.document.getElementById("cooperator3_1").value = num1;
				window.opener.document.getElementById("cooperator3_2").value = num2;
				window.opener.document.getElementById("cooperator3_3").value = num3;
				window.opener.document.getElementById("cooperator3_4").value = num4;
				
				window.close();
				
			} else if (divNo == 4){
				window.opener.document.getElementById("coo_level4_1").value = level1;
				window.opener.document.getElementById("coo_level4_2").value = level2;
				window.opener.document.getElementById("coo_level4_3").value = level3;
				window.opener.document.getElementById("coo_level4_4").value = level4;
				
				window.opener.document.getElementById("coo_name4_1").value = name1;
				window.opener.document.getElementById("coo_name4_2").value = name2;
				window.opener.document.getElementById("coo_name4_3").value = name3;
				window.opener.document.getElementById("coo_name4_4").value = name4;
				
				window.opener.document.getElementById("cooperator4_1").value = num1;
				window.opener.document.getElementById("cooperator4_2").value = num2;
				window.opener.document.getElementById("cooperator4_3").value = num3;
				window.opener.document.getElementById("cooperator4_4").value = num4;
