		            ...
		            <div class="card card-info card-outline card-outline-tabs">
		              <div class="card-header p-0 border-bottom-0">
		                <ul class="nav nav-tabs" id="custom-tabs-tempororyApproval-tab" role="tablist">
		                  <li class="nav-item">
		                    <a class="nav-link " id="custom-tabs-normalApproval-tab" href="signedNormal.ea" role="tab" aria-controls="custom-tabs-normalApproval" aria-selected="true">일반 결재</a>
		                  </li>
		                  <li class="nav-item">
		                    <a class="nav-link" id="custom-tabs-expenditureApproval-tab"  href="signedExpenditure.ea" role="tab" aria-controls="custom-tabs-expenditureApproval" aria-selected="false">지출 결재</a>
		                  </li>
		                  <!-- 근태 /휴가 탭 -->
		                  <li class="nav-item">
