...
<link rel="stylesheet" href="./resources/plugins/tuicalendar/dist/tui-calendar.css">
<script src="./resources/plugins/tuicalendar/dist/tui-calendar.js"></script>
</head>
<body>
	...
	<div class="col-2" style="background-color: gray; width:200px;'">
		<div id="insertCal" style="border: solid 1px red; height:40px;"> 일정등록 </div>
